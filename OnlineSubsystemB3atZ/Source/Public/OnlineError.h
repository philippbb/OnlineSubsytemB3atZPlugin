...
struct ONLINESUBSYSTEMB3ATZ_API FOnlineError
{
public:
	FOnlineError();
	...
	/** Converts the HttpResult into a EB3atZOnlineServerConnectionStatus */
	EB3atZOnlineServerConnectionStatus::Type GetConnectionStatusFromHttpResult() const;
