...
public:
	 ...
	 */
	virtual EB3atZOnlineCachedResult::Type GetCachedAchievement( const FUniqueNetId& PlayerId, const FString& AchievementId, FOnlineAchievement& OutAchievement) = 0;
	 ...
	 * @return Whether achievements were obtained
	 */
	virtual EB3atZOnlineCachedResult::Type GetCachedAchievements(const FUniqueNetId& PlayerId, TArray<FOnlineAchievement>& OutAchievements) = 0;
	 ...
	 * @return Whether achievements were obtained
	 */
	virtual EB3atZOnlineCachedResult::Type GetCachedAchievementDescription(const FString& AchievementId, FOnlineAchievementDesc& OutAchievementDesc) = 0;
