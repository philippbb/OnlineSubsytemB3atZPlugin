...
public:
	 ...
	 */
	virtual bool GetFriendsList(int32 LocalUserNum, const FString& ListName, TArray< TSharedRef<FB3atZOnlineFriend> >& OutFriends) = 0;
	 ...
	 */
	virtual TSharedPtr<FB3atZOnlineFriend> GetFriend(int32 LocalUserNum, const FUniqueNetId& FriendId, const FString& ListName) = 0;
	 ...
	 */
	virtual bool GetRecentPlayers(const FUniqueNetId& UserId, const FString& Namespace, TArray< TSharedRef<FB3atZOnlineRecentPlayer> >& OutRecentPlayers) = 0;
	 ...
	 */
	virtual bool GetBlockedPlayers(const FUniqueNetId& UserId, TArray< TSharedRef<FB3atZOnlineBlockedPlayer> >& OutBlockedPlayers) = 0;
