...
ONLINESUBSYSTEMB3ATZ_API DECLARE_LOG_CATEGORY_EXTERN(LogB3atZOnlineParty, Display, All);

#define ONLINEPARTY_LOG_PREFIX TEXT("OSS::Party: ")
#define UE_LOG_ONLINEPARTY(Verbosity, Format, ...) \
{ \
	UE_LOG(LogB3atZOnlineParty, Verbosity, TEXT("%s%s"), ONLINEPARTY_LOG_PREFIX, *FString::Printf(Format, ##__VA_ARGS__)); \
}
 ...
 */
class FOnlinePartyMember : public FB3atZOnlineUser
{
public:
};
 ...
 */
class ONLINESUBSYSTEMB3ATZ_API FOnlinePartyData : public TSharedFromThis<FOnlinePartyData>
{
public:
	FOnlinePartyData() :
		TotalBytes(0),
 ...
 */
struct ONLINESUBSYSTEMB3ATZ_API FPartyConfiguration : public TSharedFromThis<FPartyConfiguration>
{
	FPartyConfiguration()
