...
struct FOnlineStatusUpdate
{
	...
	EB3atZOnlineStatusUpdatePrivacy::Type PostPrivacy;
	...
	FOnlineStatusUpdate() 
		: Type(TEXT("Default"))
		, Image(NULL)
		, PostPrivacy(EB3atZOnlineStatusUpdatePrivacy::OnlyMe)
	{}
};
...
public:
	 ...
	 */
	virtual bool RequestNewReadPermissions(int32 LocalUserNum, EB3atZOnlineSharingReadCategory::Type NewPermissions) = 0;
	 ...
	 */
	virtual bool RequestNewPublishPermissions(int32 LocalUserNum, EB3atZOnlineSharingPublishingCategory::Type NewPermissions, EB3atZOnlineStatusUpdatePrivacy::Type Privacy) = 0;
...
public:
	 ...
	 */
	virtual EB3atZOnlineCachedResult::Type GetCachedNewsFeed(int32 LocalUserNum, int32 NewsFeedIdx, FOnlineStatusUpdate& OutNewsFeed) = 0;
	 ...
	 */
	virtual EB3atZOnlineCachedResult::Type GetCachedNewsFeeds(int32 LocalUserNum, TArray<FOnlineStatusUpdate>& OutNewsFeeds) = 0;
