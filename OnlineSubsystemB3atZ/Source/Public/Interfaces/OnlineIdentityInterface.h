 ...
 */
DECLARE_MULTICAST_DELEGATE_FourParams(FOnLoginStatusChanged, int32 /*LocalUserNum*/, ELoginStatusB3atZ::Type /*OldStatus*/, ELoginStatusB3atZ::Type /*NewStatus*/, const FUniqueNetId& /*NewId*/);
...
public:
	 ...
	 * @param NewId the new id to associate with the user
	 */
	DEFINE_ONLINE_PLAYER_DELEGATE_THREE_PARAM(MAX_LOCAL_PLAYERS, OnLoginStatusChanged, ELoginStatusB3atZ::Type /*Previous*/, ELoginStatusB3atZ::Type /*Current*/, const FUniqueNetId&);
	 ...
	 */
	virtual TSharedPtr<FB3atZUserOnlineAccount> GetUserAccount(const FUniqueNetId& UserId) const = 0;
	 ...
	 * @return info about the user if found, NULL otherwise
	 */
	virtual TArray<TSharedPtr<FB3atZUserOnlineAccount> > GetAllUserAccounts() const = 0;
	 ...
	 */
	virtual ELoginStatusB3atZ::Type GetLoginStatus(int32 LocalUserNum) const = 0;
	 ...
	 * @return the enum value of their status
	 */
	virtual ELoginStatusB3atZ::Type GetLoginStatus(const FUniqueNetId& UserId) const = 0;
