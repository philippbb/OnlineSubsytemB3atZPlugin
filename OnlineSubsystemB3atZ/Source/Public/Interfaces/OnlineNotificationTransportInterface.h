...
protected:
	/** Constructor */
	IOnlineNotificationTransport(IOnlineSubsystemB3atZ* InOnlineSubsystemInstance, FNotificationTransportId InTransportId)
	...
	IOnlineSubsystemB3atZ* OnlineSubsystemInstance;
