...
public:
	 ...
	 */
	virtual EB3atZOnlineSessionState::Type GetSessionState(FName SessionName) const = 0;
	...
	*/
	 ...
	 * @return true if successful searching for sessions, false otherwise
	 */
	virtual bool FindSessions(int32 SearchingPlayerNum, const TSharedRef<FOnlineSessionSearchB3atZ>& SearchSettings) = 0;
	 ...
	 * @return true if successful searching for sessions, false otherwise
	 */
	virtual bool FindSessions(const FUniqueNetId& SearchingPlayerId, const TSharedRef<FOnlineSessionSearchB3atZ>& SearchSettings) = 0;
