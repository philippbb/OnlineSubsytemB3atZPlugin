...
typedef TSharedPtr<class IOnlineSubsystemB3atZ, ESPMode::ThreadSafe> IOnlineSubsystemB3atZPtr;
 ...
 */
class FOnlineSubsystemB3atZModule : public IModuleInterface
{
private:
	...
	TMap<FName, class IB3atZOnlineFactory*> OnlineFactories;

	/** Mapping of all currently loaded platform service subsystems to their name */
	TMap<FName, IOnlineSubsystemB3atZPtr> OnlineSubsystems;
...
public:
	...
	FOnlineSubsystemB3atZModule() :
		DefaultPlatformService(NAME_None)
	{}
	virtual ~FOnlineSubsystemB3atZModule() {}
	 ...
	 */
	virtual class IOnlineSubsystemB3atZ* GetOnlineSubsystem(const FName InSubsystemName = NAME_None);
	 ...
	 */
	virtual void RegisterPlatformService(const FName FactoryName, class IB3atZOnlineFactory* Factory);
...
typedef TSharedPtr<FOnlineSubsystemB3atZModule, ESPMode::ThreadSafe> FOnlineSubsystemB3atZModulePtr;
