 ...
 */
class ONLINESUBSYSTEMB3ATZ_API FOnlineStats
{
public:
 ...
 */
class ONLINESUBSYSTEMB3ATZ_API FOnlineLeaderboardWrite : public FOnlineStats
{
public:

	/** Sort Method */
	EB3atZLeaderboardSort::Type SortMethod;
	/** Display Type */
	EB3atZLeaderboardFormat::Type DisplayFormat;
	/** Update Method */
	EB3atZLeaderboardUpdateMethod::Type UpdateMethod;
	...
	FOnlineLeaderboardWrite() :
		SortMethod(EB3atZLeaderboardSort::None),
		DisplayFormat(EB3atZLeaderboardFormat::Number),
		UpdateMethod(EB3atZLeaderboardUpdateMethod::KeepBest),
		RatedStat(NAME_None)
	{
	}
};
 ...
 */
class ONLINESUBSYSTEMB3ATZ_API FOnlineLeaderboardRead
{
public:
 ...
 */
class ONLINESUBSYSTEMB3ATZ_API FOnlineAchievementsWrite : public FOnlineStats
{
public:
	/**
	 * Constructor
	...
	FOnlineAchievementsWrite() :
		WriteState(EB3atZOnlineAsyncTaskState::NotStarted)
	{

	}

	/** Indicates an error reading data occurred while processing */
	EB3atZOnlineAsyncTaskState::Type WriteState;
};
