...
#include "B3atZPartyBeaconState.h"
#include "OnlineBeaconHostObject.h"
#include "B3atZPartyBeaconHost.generated.h"

class AB3atZPartyBeaconClient;
 ...
 */
DECLARE_DELEGATE_RetVal_OneParam(bool, FOnValidatePlayers, const TArray<FB3atZPlayerReservation>&);
 ...
 */
DECLARE_DELEGATE_OneParam(FOnDuplicateReservation, const FB3atZPartyReservation&);

/**
 * A beacon host used for taking reservations for an existing game session
 */
UCLASS(transient, notplaceable, config=Engine)
class ONLINESUBSYSTEMB3ATZUTILS_API ADirectPartyBeaconHost : public AB3atZOnlineBeaconHostObject
{
	...
	//~ Begin AB3atZOnlineBeaconHostObject Interface 
	 ...
	 * @return true if successful created, false otherwise
	 */
	virtual bool InitFromBeaconState(UB3atZPartyBeaconState* PrevState);
	 ...
	 */
	UB3atZPartyBeaconState* GetState() const { return State; }
	 ...
	 */
	virtual EB3atZPartyReservationResult::Type AddPartyReservation(const FB3atZPartyReservation& ReservationRequest);
	 ...
	 */
	virtual EB3atZPartyReservationResult::Type UpdatePartyReservation(const FB3atZPartyReservation& ReservationUpdateRequest);
	 ...
	 */
	virtual EB3atZPartyReservationResult::Type RemovePartyReservation(const FUniqueNetIdRepl& PartyLeader);
	 ...
	 */
	virtual void ProcessReservationRequest(AB3atZPartyBeaconClient* Client, const FString& SessionId, const FB3atZPartyReservation& ReservationRequest);
	 ...
	 */
	virtual void ProcessReservationUpdateRequest(AB3atZPartyBeaconClient* Client, const FString& SessionId, const FB3atZPartyReservation& ReservationUpdateRequest);
	 ...
	 * @param PartyLeader reservation leader
	 */
	virtual void ProcessCancelReservationRequest(AB3atZPartyBeaconClient* Client, const FUniqueNetIdRepl& PartyLeader);
...
protected:
	 ...
	 */
	virtual TSubclassOf<UB3atZPartyBeaconState> GetPartyBeaconHostClass() const { return UB3atZPartyBeaconState::StaticClass(); }
	 ...
	 */
	void NewPlayerAdded(const FB3atZPlayerReservation& NewPlayer);
