...
#include "B3atZOnlineBeacon.generated.h"

class FInBunch;
class UChannel;
class UNetConnection;

ONLINESUBSYSTEMB3ATZUTILS_API DECLARE_LOG_CATEGORY_EXTERN(LogBeacon, Display, All);
...
class ONLINESUBSYSTEMB3ATZUTILS_API AB3atZOnlineBeacon : public AActor, public FNetworkNotify
{
