...
class FVoiceEngineImpl : public IVoiceEngine
{
	...
	typedef TMap<class FB3atZUniqueNetIdString, FRemoteTalkerDataImpl> FRemoteTalkerData;
...
public:
	...
	FVoiceEngineImpl(IOnlineSubsystemB3atZ* InSubsystem);
	...
	{
		return RemoteTalkerBuffers.Find((const FB3atZUniqueNetIdString&)UniqueId) != NULL;
	}
