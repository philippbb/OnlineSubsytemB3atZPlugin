...
#include "B3atZPartyBeaconState.generated.h"

/** The result code that will be returned during party reservation */
UENUM()
namespace EB3atZPartyReservationResult
{
	enum Type
	{
		/** Empty state. */
...
namespace EB3atZPartyReservationResult
{
	...
	inline const TCHAR* ToString(EB3atZPartyReservationResult::Type SessionType)
	{
		switch (SessionType)
		{
			case NoResult:
	...
	inline FText GetDisplayString(EB3atZPartyReservationResult::Type Response)
	{
		switch (Response)
		{
		case EB3atZPartyReservationResult::IncorrectPlayerCount:
		case EB3atZPartyReservationResult::PartyLimitReached:
			return NSLOCTEXT("EB3atZPartyReservationResult", "FullGame", "Game full");
		case EB3atZPartyReservationResult::RequestTimedOut:
			return NSLOCTEXT("EB3atZPartyReservationResult", "NoResponse", "No response");
		case EB3atZPartyReservationResult::ReservationDenied:
			return NSLOCTEXT("EB3atZPartyReservationResult", "DeniedResponse", "Not accepting connections");
		case EB3atZPartyReservationResult::ReservationDenied_Banned:
			return NSLOCTEXT("EB3atZPartyReservationResult", "BannedResponse", "Player Banned");
		case EB3atZPartyReservationResult::GeneralError:
			return NSLOCTEXT("EB3atZPartyReservationResult", "GeneralError", "Unknown Error");
		case EB3atZPartyReservationResult::ReservationNotFound:
			return NSLOCTEXT("EB3atZPartyReservationResult", "ReservationNotFound", "No Reservation");
		case EB3atZPartyReservationResult::ReservationAccepted:
			return NSLOCTEXT("EB3atZPartyReservationResult", "Accepted", "Accepted");
		case EB3atZPartyReservationResult::ReservationDuplicate:
			return NSLOCTEXT("EB3atZPartyReservationResult", "DuplicateReservation", "Duplicate reservation detected");
		case EB3atZPartyReservationResult::ReservationInvalid:
			return NSLOCTEXT("EB3atZPartyReservationResult", "InvalidReservation", "Bad reservation request");
		case EB3atZPartyReservationResult::NoResult:
		case EB3atZPartyReservationResult::BadSessionId:
		default:
...
namespace ETeamAssignmentMethod
{
	...
	extern ONLINESUBSYSTEMB3ATZUTILS_API const FName Smallest;
	/** Optimize for best fit within the number of available reservations */
	extern ONLINESUBSYSTEMB3ATZUTILS_API const FName BestFit;
	/** Assign random team */
	extern ONLINESUBSYSTEMB3ATZUTILS_API const FName Random;
}

/** A single player reservation */
USTRUCT()
struct FB3atZPlayerReservation
{
	GENERATED_USTRUCT_BODY()
	
	FB3atZPlayerReservation() :
		ElapsedTime(0.0f)
	{}
...
USTRUCT()
struct ONLINESUBSYSTEMB3ATZUTILS_API FB3atZPartyReservation
{
	GENERATED_USTRUCT_BODY()

	FB3atZPartyReservation() :
		TeamNum(INDEX_NONE)
	{}
	...
	UPROPERTY(Transient)
	TArray<FB3atZPlayerReservation> PartyMembers;
...
class ONLINESUBSYSTEMB3ATZUTILS_API UB3atZPartyBeaconState : public UObject
{
	 ...
	 */
	virtual bool AddReservation(const FB3atZPartyReservation& ReservationRequest);
	 ...
	 */
	virtual TArray<FB3atZPartyReservation>& GetReservations() { return Reservations; }
	...
	*/
	 ...
	 */
	virtual bool DoesReservationFit(const FB3atZPartyReservation& ReservationRequest) const;
	...
	*/
	virtual bool AreTeamsAvailable(const FB3atZPartyReservation& ReservationRequest) const;
	...
	*/
	virtual int32 GetTeamAssignment(const FB3atZPartyReservation& Party);
...
protected:
	...
	UPROPERTY(Transient)
	TArray<FB3atZPartyReservation> Reservations;
	...
	friend class ADirectPartyBeaconHost;
};
