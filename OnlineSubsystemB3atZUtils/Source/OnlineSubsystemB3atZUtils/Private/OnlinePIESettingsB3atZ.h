...
#include "OnlinePIESettingsB3atZ.generated.h"
 ...
 */
USTRUCT()
struct FPIELoginSettingsInternalB3atZ
{
public:
...
class UB3atZOnlinePIESettingsB3atZ : public UDeveloperSettings
{
	GENERATED_BODY()

public:
	UB3atZOnlinePIESettingsB3atZ(const FObjectInitializer& ObjectInitializer);
	...
	TArray<FPIELoginSettingsInternalB3atZ> Logins;
