...
{
	// Cache interfaces
	OnlineSub = IOnlineSubsystemB3atZ::Get(FName(*SubsystemName));
	check(OnlineSub); 
	...
	{
		UE_LOG(LogB3atZOnline, Error, TEXT("ExternalUI test -- No UIs selected to test"));
		FinishTest();
	}
	else
	{
...
{
	UE_LOG(LogB3atZOnline, Log, TEXT("FTestExternalUIInterface::FinishTest -- completed testing"));
...
bool FTestExternalUIInterface::TestLoginUI()
{
	...
	{
		UE_LOG(LogB3atZOnline, Log, TEXT("TestLoginUI (skipping)"));
		return false;
	}
	...
	UE_LOG(LogB3atZOnline, Log, TEXT("TestLoginUI bShowingUI: %d"), bShowingUI);
	return bShowingUI;
}
...
bool FTestExternalUIInterface::TestFriendsUI()
{
	...
	{
		UE_LOG(LogB3atZOnline, Log, TEXT("TestFriendsUI (skipping)"));
		return false;
	}

	bool bShowingUI = ExternalUI->ShowFriendsUI(0);
	UE_LOG(LogB3atZOnline, Log, TEXT("TestFriendsUI bShowingUI: %d"), bShowingUI);
	return bShowingUI;
}
...
bool FTestExternalUIInterface::TestInviteUI()
{
	...
	{
		UE_LOG(LogB3atZOnline, Log, TEXT("TestInviteUI (skipping)"));
		return false;
	}

	bool bShowingUI = ExternalUI->ShowInviteUI(0);
	UE_LOG(LogB3atZOnline, Log, TEXT("TestInviteUI bShowingUI: %d"), bShowingUI);
	return bShowingUI;
}
...
bool FTestExternalUIInterface::TestAchievementsUI()
{
	...
	{
		UE_LOG(LogB3atZOnline, Log, TEXT("TestAchievementsUI (skipping)"));
		return false;
	}

	bool bShowingUI = ExternalUI->ShowAchievementsUI(0);
	UE_LOG(LogB3atZOnline, Log, TEXT("TestAchievementsUI bShowingUI: %d"), bShowingUI);
	return bShowingUI;
}
...
bool FTestExternalUIInterface::TestWebURL()
{
	...
	{
		UE_LOG(LogB3atZOnline, Log, TEXT("TestWebURL (skipping)"));
		return false;
	}
	...
	UE_LOG(LogB3atZOnline, Log, TEXT("TestWebURL bShowingUI: %d"), bShowingUI);
	return bShowingUI;
}
...
bool FTestExternalUIInterface::TestProfileUI()
{
	...
	{
		UE_LOG(LogB3atZOnline, Log, TEXT("TestProfileUI (skipping)"));
		return false;
	}
	...
	UE_LOG(LogB3atZOnline, Log, TEXT("TestProfileUI bShowingUI: %d"), bShowingUI);
	return bShowingUI;
}

void FTestExternalUIInterface::OnExternalUIChange(bool bIsOpening)
{
	UE_LOG(LogB3atZOnline, Log, TEXT("OnExternalUIChange delegate invoked. bIsOpening = %d"), bIsOpening);
...
{
	UE_LOG(LogB3atZOnline, Log, TEXT("Login UI closed by local user %d. Logged-in user = %s"), LocalUserId, *LoggedInUserId->ToString());
}

void FTestExternalUIInterface::OnProfileUIClosed()
{
	UE_LOG(LogB3atZOnline, Log, TEXT("Profile UI closed by user."));
}

void FTestExternalUIInterface::OnShowWebUrlClosed(const FString& FinalUrl)
{
	UE_LOG(LogB3atZOnline, Log, TEXT("Show Web Url closed with FinalUrl=%s."), *FinalUrl);
}
