...
UDirectAchievementWriteCallbackProxy::UDirectAchievementWriteCallbackProxy(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
	, WorldContextObject(nullptr)
{
}

UDirectAchievementWriteCallbackProxy* UDirectAchievementWriteCallbackProxy::WriteAchievementProgress(UObject* WorldContextObject, class APlayerController* PlayerController, FName AchievementName, float Progress, int32 UserTag)
{
	UDirectAchievementWriteCallbackProxy* Proxy = NewObject<UDirectAchievementWriteCallbackProxy>();
...
void UDirectAchievementWriteCallbackProxy::Activate()
{
...
void UDirectAchievementWriteCallbackProxy::OnAchievementWritten(const FUniqueNetId& UserID, bool bSuccess)
{
	if (bSuccess)
	{
...
void UDirectAchievementWriteCallbackProxy::BeginDestroy()
{
	WriteObject.Reset();
