...
FVoiceEngineImpl::FVoiceEngineImpl(IOnlineSubsystemB3atZ* InSubsystem) :
...
{
	const FB3atZUniqueNetIdString& RemoteTalkerId = (const FB3atZUniqueNetIdString&)UniqueId;
...
uint32 FVoiceEngineImpl::SubmitRemoteVoiceData(const FUniqueNetId& RemoteTalkerId, uint8* Data, uint32* Size)
{
	...
	const FB3atZUniqueNetIdString& TalkerId = (const FB3atZUniqueNetIdString&)RemoteTalkerId;
