...
UCLASS(MinimalAPI)
class UDirectLeaderboardQueryCallbackProxy : public UObject
{
	...
	static UDirectLeaderboardQueryCallbackProxy* CreateProxyObjectForIntQuery(class APlayerController* PlayerController, FName StatName);
