...
UCLASS(MinimalAPI)
class UDirectAchievementWriteCallbackProxy : public UOnlineBlueprintCallProxyBase
{
	...
	static UDirectAchievementWriteCallbackProxy* WriteAchievementProgress(UObject* WorldContextObject, APlayerController* PlayerController, FName AchievementName, float Progress = 100.0f, int32 UserTag = 0);
