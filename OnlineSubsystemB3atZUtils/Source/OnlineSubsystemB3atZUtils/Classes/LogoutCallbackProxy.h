...
UCLASS(MinimalAPI)
class UDirectLogoutCallbackProxy : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()

public:
	UDirectLogoutCallbackProxy(const FObjectInitializer& ObjectInitializer);
	...
	static UDirectLogoutCallbackProxy* Logout(UObject* WorldContextObject, class APlayerController* PlayerController);
