...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FInAppPurchaseQueryResult, const TArray<FB3atZInAppPurchaseProductInfo>&, InAppPurchaseInformation);

UCLASS(MinimalAPI)
class UDirectInAppPurchaseQueryCallbackProxy : public UObject
{
	...
	static UDirectInAppPurchaseQueryCallbackProxy* CreateProxyObjectForInAppPurchaseQuery(class APlayerController* PlayerController, const TArray<FString>& ProductIdentifiers);
...
private:
	...
	TArray<FB3atZInAppPurchaseProductInfo> SavedProductInformation;
};
