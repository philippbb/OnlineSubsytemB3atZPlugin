...
UCLASS(MinimalAPI)
class UDirectLeaderboardFlushCallbackProxy : public UObject
{
	...
	static UDirectLeaderboardFlushCallbackProxy* CreateProxyObjectForFlush(class APlayerController* PlayerController, FName SessionName);
