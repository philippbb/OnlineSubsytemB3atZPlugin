...
UCLASS(MinimalAPI)
class UDirectConnectionCallbackProxy : public UOnlineBlueprintCallProxyBase
{
	...
	UFUNCTION(BlueprintCallable, meta = (DeprecatedFunction, DeprecationMessage="Please use Show External Login UI instead", BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject"), Category = "Online|Achievements")
		static UDirectConnectionCallbackProxy* ConnectToService(UObject* WorldContextObject, class APlayerController* PlayerController);
