...
class ONLINESUBSYSTEMB3ATZUTILS_API UIpNetDriverB3atZ : public UNetDriver
{
	...
	//~ Begin UIpNetDriverB3atZ Interface.
	...
	//~ End UIpNetDriverB3atZ Interface.
	...
	class UIpConnectionB3atZ* GetServerConnection();
